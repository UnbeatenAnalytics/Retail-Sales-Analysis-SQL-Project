...
-- Q.2: Write a SQL query to find out total quantity sales for each category?
SELECT 
	category,
...
-- Q.6: Write a SQL Query to find all transactions where the total_sales is greater than 1000.
SELECT * FROM Retail_Sales
WHERE total_sale > 1000;

-- Q.7: Write a SQL Query to find the total number of transactions (transactions_id) made by each gender in each category?
SELECT
	category,
	gender,
...
-- Q.8: Write a SQL query to calculate average sale for each month. find out the best selling month in each year.
SELECT
	year,
	month,
	avg_sale_by_month
...
-- Q.11: Write a SQL Query to create each shift and number of orders (Example Morning <=12, Afternoon between 12 and 17, Evening > 17)?
WITH shiftwise_sale
AS
(
SELECT *,
